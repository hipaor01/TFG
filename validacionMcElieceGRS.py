import argparse
from McElieceGRS import CifradoDescifrado
...
if __name__ == '__main__':
    ...
    for parametro in parametros:
        ...
        for i in range(args.numIteraciones):
            ...
            ct, ptCandidato,pt = CifradoDescifrado(parametro[0],parametro[1],parametro[2],parametro[3],parametro[4], None)
            #Finalizamos medición del tiempo
            final = time.perf_counter()
            #Convertimos el texto plano a lista porque sino va a fallar la comprobación de igualdad
            if list(pt) == ptCandidato:
                numExitos += 1
        ...
        if parametro[3] is not None:
            print("Orden Subcuerpo primo: " + str(parametro[3]))
